...
public class ExcelUtil {
    ...
    //Excel FIle Name 
    private static String testDataExcelFileName = null;

	public  String getTestDataExcelFileName() {
		return testDataExcelFileName;
	}

	public static void setTestDataExcelFileName(String testDataExcelFileName) {
		ExcelUtil.testDataExcelFileName = testDataExcelFileName;
	}
